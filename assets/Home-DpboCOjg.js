import{w,r,u as i,s as a,v as m,x as E,j as e,y as C,L,S as v}from"./index-DeAwb6II.js";import{u as S,T as o,m as I}from"./routes-tbC5MfZn.js";const M=()=>{const t=w(),s=r.useRef("");r.useEffect(()=>{t.hash&&(s.current=t.hash.slice(1)),s.current&&document.getElementById(s.current)&&setTimeout(()=>{var l;(l=document.getElementById(s.current))==null||l.scrollIntoView({behavior:"smooth",block:"start"}),s.current=""},100)},[t])},B=i.section`
  display: flex;
...
`,me=i.div`
  ...
  border-radius: 0.4rem;
  overflow: hidden;
`,Ae=({experienceData:t})=>e.jsx(de,{children:t.map(({icons:s,title:l,dateFrom:c,dateTo:h,Description:x})=>e.jsxs(pe,{children:[e.jsxs(xe,{children:[e.jsxs(he,{children:[e.jsx(me,{children:e.jsxs("picture",{children:[e.jsx("source",{srcSet:s[0],type:"image/webp"}),e.jsx("img",{loading:"lazy",src:s[1],alt:l,width:32,height:32})]})}),e.jsx(o,{variant:"h3",children:l})]}),e.jsxs(v,{children:[c," - ",h]})]}),e.jsx(x,{})]},l))}),d=i.div`
  display: flex;
  flex-direction: column;
  row-gap: 3rem;
`,p=i.ul`
