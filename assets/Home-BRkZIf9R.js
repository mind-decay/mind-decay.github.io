...
`,f="/assets/Avatar-a5XW2jSW.png",Z="/assets/Avatar-Bvo0b_Cv.webp",T="/assets/Avatar2x-DRYoIK7-.png",H="/assets/Avatar2x-BVRbqmLw.webp",k=()=>{const[t,s]=r.useState(!1);return e.jsxs(R,{children:[!t&&e.jsx(F,{"aria-label":"Avatar is loading, please wait..."}),e.jsxs("picture",{children:[e.jsx("source",{srcSet:`${Z} 250w, ${H} 375w`,type:"image/webp",sizes:`(max-width: ${a.tablet}px) 250px, 375px`}),e.jsx("img",{srcSet:`${f} 250w, ${T} 375w`,sizes:`(max-width: ${a.tablet}px) 250px, 375px`,src:f,alt:"My simple avatar",width:250,height:250,onLoad:()=>s(!0)})]})]})},E=h`
  padding: 1.5rem 3rem;
  ${g.button}
  border-radius: 5rem;
...
`,V=i.button`
  ${({$variant:t})=>t==="primary"?C:j}
`,X=i.a`
  ${({$variant:t})=>t==="primary"?C:j}
`,K=i(L)`
  ${({$variant:t})=>t==="primary"?C:j}
`,u=({variant:t,onClick:s,href:l,target:p,to:x,children:A})=>x?e.jsx(K,{to:x,$variant:t,children:A}):l?e.jsx(X,{href:l,target:p,$variant:t,children:A}):e.jsx(V,{onClick:s,$variant:t,children:A}),G=i.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  row-gap: 4.8rem;
...
`,ae=({skillsData:t})=>e.jsx(ie,{children:t.map(s=>e.jsx(se,{children:e.jsx("span",{children:s})},s))}),oe=["HTML","CSS","SCSS","Styled-Components","Tailwindcss","JavaScript","TypeScript","React","Next.js","Solid.js","Redux","Effector","Webpack","Vite","Rollup","Gulp","Jest","React Testing Library","Cypress","Playwright","REST API","Formik","React Hook Form","Axios","AntD","MUI","Chakra UI","Reatom","Storybook","Gravity UI"],le=()=>e.jsxs(ne,{id:"skills",children:[e.jsx(o,{variant:"h2",gradient:"mainGradient",children:"Навыки"}),e.jsx(ae,{skillsData:oe})]}),ce=i.section`
  display: flex;
  flex-direction: column;
  align-items: center;
  row-gap: 5.5rem;
...
`,he=i.div`
  ...
  border-radius: 0.4rem;
  overflow: hidden;
`,me=({experienceData:t})=>e.jsx(de,{children:t.map(({icons:s,title:l,dateFrom:p,dateTo:x,Description:A})=>e.jsxs(pe,{children:[e.jsxs(Ae,{children:[e.jsxs(xe,{children:[e.jsx(he,{children:e.jsxs("picture",{children:[e.jsx("source",{srcSet:s[0],type:"image/webp"}),e.jsx("img",{loading:"lazy",src:s[1],alt:l,width:32,height:32})]})}),e.jsx(o,{variant:"h3",children:l})]}),e.jsxs(v,{children:[p," - ",x]})]}),e.jsx(A,{})]},l))}),c=i.div`
  display: flex;
  flex-direction: column;
  row-gap: 3rem;
`,d=i.ul`
